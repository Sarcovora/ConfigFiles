...
updateconfs () {
    ...
    cp -r ~/.config/betterlockscreenrc ~/.config/vmware_launch.sh ~/Github/ConfigFiles/Arch/dotfiles/
    
    cp -r ~/.local/share/applications/feh.desktop ~/.config/kitty ~/Github/ConfigFiles/Arch/dotfiles/
    
    cp -r ~/.config/neofetch ~/.config/ranger ~/.config/nvim/ ~/Github/ConfigFiles/Arch/dotfiles/

    cp -r ~/.config/figletFonts/ ~/.config/starship.toml ~/Github/ConfigFiles/Arch/dotfiles/
