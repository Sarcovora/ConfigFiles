...
GIT_DIR="$HOME/Github/ConfigFiles/Arch"
...
updateconfs () {
    ...
    cp -r ~/.config/i3 ~/.config/picom $GIT_DIR/dotfiles/
    
    cp -r ~/.config/polybar ~/.config/termite ~/.config/rofi $GIT_DIR/dotfiles/

    cp -r ~/.config/betterlockscreenrc ~/.config/vmware_launch.sh $GIT_DIR/dotfiles/
    
    cp -r ~/.local/share/applications/feh.desktop ~/.config/kitty $GIT_DIR/dotfiles/
    
    cp -r ~/.config/neofetch ~/.config/ranger ~/.config/nvim/ $GIT_DIR/dotfiles/

    cp -r ~/.config/figletFonts/ ~/.config/starship.toml $GIT_DIR/dotfiles/
